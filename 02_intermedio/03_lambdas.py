...
# Las funciones lambda en Python son funciones anónimas y por lo general 
# pequeñas que se pueden definir de forma concisa y en una sola línea. 

# Función lambda para la suma
# Recibe dos parametros x e y y se define la acción a realizar
# Esta función lambda se almacena en una variable
suma = lambda x, y: x + y
